    ...
    <div className="p-4 md:p-6">
      <div className="flex items-start justify-between gap-3 mb-4">
        <div>
          ...
          <p className="text-xs text-gray-500">{suppliers.length} suppliers, who supplies most, costs most, and earns the best margin</p>
        </div>
          ...
          <tbody className="divide-y divide-gray-50 dark:divide-gray-700">
            {rows.map((s, i) => (
              <tr key={i} className="hover:bg-violet-50/40">
                ...
                <td className="px-3 py-2 text-right font-medium text-violet-600">{masked ? STARS : eur(s.spend || 0)}</td>
